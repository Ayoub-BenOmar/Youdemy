...
<body class="bg-gray-100 flex flex-col">
    ...
    <div class="flex flex-1">
        ...
        <div class="main-content flex-1 p-6 ml-64 flex flex-col">
            <h1 class="text-3xl font-bold text-purple-700 mb-6">Categories & Tags Management</h1>

            <!-- Categories Section -->
            <div class="mb-10">
                <h2 class="text-2xl font-semibold text-purple-700 mb-4">Categories</h2>
            ...
            <!-- Tags Section -->
            <div>
                <h2 class="text-2xl font-semibold text-purple-700 mb-4">Tags</h2>
                <div class="grid grid-cols-2 gap-6">
                    <!-- Add Tag Form -->
                    <div>
